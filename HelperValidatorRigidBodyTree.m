    ...
    methods
        function obj = HelperValidatorRigidBodyTree(ssRBT)
            ...
            for i = 1:robot.NumBodies
                V = robot.Bodies{i}.VisualsInternal{1}.Vertices; % only extracting the first geometry in each body
                T = robot.Bodies{i}.VisualsInternal{1}.Tform;
                V = double(V);
